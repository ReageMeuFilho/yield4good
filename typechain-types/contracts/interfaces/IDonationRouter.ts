...
export interface IDonationRouterInterface extends Interface {
...
export interface IDonationRouter extends BaseContract {
  connect(runner?: ContractRunner | null): IDonationRouter;
  waitForDeployment(): Promise<this>;

  interface: IDonationRouterInterface;
